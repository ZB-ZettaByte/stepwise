...
export interface Translations {
  ...
  // Custom array input
  customArrayLabel: string
  customArrayPlaceholder: string
  customArrayButton: string
  customArrayReset: string
  customArrayHint: string // "Whole numbers {min}–{max}, up to {count}"
  customArrayErrorEmpty: string
  customArrayErrorInvalid: string
...
export const translations: Record<Locale, Translations> = {
  en: {
    ...
    welcomeTitle: 'Welcome to Stepwise',
    welcomeDescription:
    ...
    customArrayLabel: 'Custom array',
    customArrayPlaceholder: 'e.g. 5, 3, 8, 1, 9',
    customArrayButton: 'Visualize',
    customArrayReset: 'Reset',
    customArrayHint: 'Whole numbers {min}–{max}, up to {count}',
    customArrayErrorEmpty: 'Enter at least one number.',
    customArrayErrorInvalid: 'Use numbers separated by commas, e.g. 5, 3, 8, 1, 9',
...
Named after the Greek mathematician Eratosthenes of Cyrene (~276–194 BCE), this sieve remains one of the most efficient ways to find all small primes and is the basis for many factorization preprocessing steps.`,
  ...
  es: {
    ...
    welcomeTitle: 'Bienvenido a Stepwise',
    welcomeDescription:
    ...
    customArrayLabel: 'Arreglo personalizado',
    customArrayPlaceholder: 'ej. 5, 3, 8, 1, 9',
    customArrayButton: 'Visualizar',
    customArrayReset: 'Restablecer',
    customArrayHint: 'Números enteros {min}–{max}, hasta {count}',
    customArrayErrorEmpty: 'Ingresa al menos un número.',
    customArrayErrorInvalid: 'Usa números separados por comas, ej. 5, 3, 8, 1, 9',
...
export function getAlgorithmMetaTitle(
  ...
  if (!desc) return `${fallbackName} | Stepwise`
  const firstLine = desc.split('\n')[0].trim()
  return `${firstLine || fallbackName} | Stepwise`
}
