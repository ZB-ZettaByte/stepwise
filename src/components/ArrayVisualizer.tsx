...
export default function ArrayVisualizer({ step, density = 'default' }: ArrayVisualizerProps) {
  ...
  return (
    <div
      className={`flex-1 flex flex-col items-center justify-center w-full ${isLanding ? 'gap-3 md:gap-4' : 'gap-6'}`}
      role="img"
    ...
    >
      ...
      <div
        ...
        style={{
          height: isLanding ? 'clamp(150px, 20vw, 230px)' : 'clamp(180px, 40vw, 300px)',
          gap: `${barGap}px`,
        }}
        aria-hidden="true"
      >
          ...
          return (
            <div
              ...
              style={{
                ...
                color: color,
                borderBottom: highlight ? `2px solid ${color}55` : '2px solid transparent',
              }}
            >
              {index}
            </div>
