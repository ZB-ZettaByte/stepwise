...
[**Empezar a explorar →**](https://Stepwise/es/)
...
Stack · Queue · Linked List · Hash Table · Binary Search Tree · Heap · Union-Find · Red-Black Tree

</td>
<td width="25%" valign="top">

### Grafos
BFS · DFS · Dijkstra · Prim · Kruskal's MST · Topological Sort

</td>
<td width="25%" valign="top">

### Búsqueda
Binary Search · Linear Search · Jump Search · Interpolation Search · Quickselect
...
### Conceptos
Big O · Worst-case Analysis · Recursión · Two Pointers · Sliding Window · Memoización · Greedy vs DP · Space Complexity
...
MIT — creado por Sai Rithwik Kukunuri
